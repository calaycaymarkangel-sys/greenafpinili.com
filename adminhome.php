...
<!-- CSS (auto-refresh using PHP timestamp) -->
...
<section class="image-section">
  <div class="image-wrap">
    <!-- Default image -->
    <img id="envImage" src="images/imress.jpg" alt="Philippine Nature Image" />
    <div class="overlay" id="advocacyText">
      Protecting nature begins in our own community.
    </div>
  </div>
</section>
...
// Paths to images (ensure folder name is "images")
const images = [
  "images/imgres.jpg",
  "images/imm2.jpg"
];

// List of advocacy quotes
const advocacies = [
...
// Load first image/text immediately
updateContent();
